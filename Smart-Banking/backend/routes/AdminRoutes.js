...
const { updateKYCStatus, listKYCRequests ,listUsers,submitKYC,adminUpdateAccount,adminDeleteAccount,createUserAndAccount} = require("../controllers/accountController");
...
router.get("/users", authMiddleware, adminMiddleware, listUsers);
 ...
 router.post("/accountTypes",authMiddleware,adminMiddleware,createAccountTypes);
  ...
  router.post("/create-user-account", authMiddleware, adminMiddleware, createUserAndAccount);
 router.patch("/account/:id", authMiddleware, adminMiddleware, adminUpdateAccount);
 router.delete("/account", authMiddleware, adminMiddleware, adminDeleteAccount);
